...
const ROOMS_16_40 = Array.from({ length: 25 }, (_, i) => i + 16);
...
/** Parse form/option value to stored type: number for 1–13, 16–40; string for 14A, 14B, 15A, 15B. */
...
export function formatRoomDisplay(roomId: RoomId): string {
  return `Room ${roomId}`;
}
